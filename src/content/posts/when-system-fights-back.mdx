export const meta = {
  ...
  date: "2025-01-15",
  summary:
    "How controlled failure testing exposed retry storms, strengthened resilience, and changed the team's engineering culture.",
  tags: ["DevOps", "ChaosEngineering"],
}

![chaos_monkey](/posts/images/chaos-monkey.webp)
...
![(Image Source: How chaos engineering will guarantee the resilience of your services)](/posts/images/chaos-diagram.webp)
